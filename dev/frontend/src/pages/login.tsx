      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="flex flex-1 items-center justify-center p-6">
          <div className="glass-card max-w-md w-full p-8 rounded-2xl">
            ...
            <h1 className="text-3xl font-bold text-center mb-2 text-accent logo-font">Moosic</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                className="w-full py-3 px-4 bg-bgSecondary border border-gray-700 rounded-lg focus:border-accent focus:ring focus:ring-accent/20"
              />
              <input
                type="password"
                name="password"
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center text-textSecondary">
                  <input type="checkbox" className="w-5 h-5 mr-2 rounded bg-bgSecondary" />
                  Remember me
                </label>
